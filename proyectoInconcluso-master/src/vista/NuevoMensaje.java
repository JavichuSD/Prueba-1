...
public class NuevoMensaje extends javax.swing.JFrame {
    ...
    public NuevoMensaje() {
        ...
        this.enviarButton.addActionListener((e)->{
        actionEnviar(e);
        });
    }
        public void actionEnviar(ActionEvent e){
        if (e.getActionCommand().equals("Enviar")) {    
            String contenido=""+cuerpoMensajeTA.getText();
            int id_usr_receptor=(int) destinatarioCB.getSelectedItem();
            
            
            MensajeDAO m= new MensajeDAO();
            m.insertarMensaje(new Mensaje(contenido, id_usr_receptor,id_usr_emisor));
